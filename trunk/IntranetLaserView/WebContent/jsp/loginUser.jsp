	...
	<s:form action="initRegisterUser" id="form" method="post" validate="true" cssStyle="margin-top: 3%;">
		...
		<div>
			...
			<div align="center" style="font:bold;color:back;padding-left: 55px;">				
	      	...
	      	<p>
	      		<s:textfield name="user.nrUsuario" id="nrUsuario" required="true" label="Nº Usuário" title="Número do Usuário" placeholder="Número do Usuário" cssStyle="width:300px" onkeypress="javascript:validarConteudo(event, 'numero');"/>
	      	</P>
	      	<p>
		...
		<table>
			<tr>
				<td>
		   			<s:submit action="autenticarColaborador" id="login" key="label.send" onclick="javascrit:validar();" cssClass="button" cssStyle="width:200px"/>
